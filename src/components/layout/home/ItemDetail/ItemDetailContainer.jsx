...
const ItemDetailContainer = () => {
    ...
    useEffect(()=>{
        let arrayProducts = [
            ...
            {id: 105, title: "Remera deportiva", price: 30, categoria: 'gimnasio', pictureUrl: "https://http2.mlstatic.com/D_NQ_NP_821595-MLA44444960415_122020-W.jpg", stock:3, description: 'Talle: L-XL-XXL. Tela  de primera calidad. Aldogon peinado.'},
